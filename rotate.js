...
function preload ()
{
    ...
    this.load.image('block', 'assets/lamp1.png');
    this.load.spritesheet('positionButton', 'assets/container3.png', { frameWidth: 74, frameHeight: 23 });
    this.load.spritesheet('rotationButton', 'assets/container3.png', { frameWidth: 74, frameHeight: 23 });
}
