...
function preload ()
{
    ...
    this.load.image('sky', 'assets/meadow/summer.jpg');
    this.load.image('strip', 'assets/meadow/grass-strip.png');
    this.load.atlas('grass', 'assets/meadow/grass.png', 'assets/tests/meadow/grass.json');
}
