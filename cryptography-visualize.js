...
class GradientColor {
  ...
  class RGB {
    ...
    static spread(n) {
        let hues = [0, 15, 40, 50, 70, 90, 110, 140, 170, 200, 220, 240, 270, 300, 340, 360].reverse();
        let lights = [30, 50, 40, 50, 40, 50, 30, 65, 30, 55, 47, 77, 63, 67, 40, 50].reverse();
        let golden = 0.5 * (3 - Math.sqrt(5));
        let x = (n * golden % 1.0) * (hues.length - 1);
        let i = Math.floor(x);
        let f = x % 1.0;
